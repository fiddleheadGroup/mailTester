...
public class ProgramConfig extends Properties
{
    ...
    public ProgramConfig(String configFileName) throws Exception
    {
        ...
        sprop = getProperty("emailCount");
        if(sprop == null) {
            setProperty("emailCount", "" + m_emailCount);
        } else {
            m_emailCount = sprop;
        } 
    ...
    private static String m_emailCount = "1";
    public static String getemailCount() { return m_emailCount; }
    public static void setemailCount(String name) { m_emailCount = name; m_this.setProperty("emailCount", "" + name); }
    
    private static String m_template = "Project acorn...";
    ...
    private static String m_subject = "acornPost TEST MAIL";
    ...
    private static String m_fromAddr = "acorn@projectacorn.com";
    ...
    private static String m_replyAddr = "acorn@projectacorn.com";
    ...
    private static String m_toAddr = "acorn@projectacorn.com";
    ...
    private static String m_listUnsub = "<http://www.projectacorn.com/public/redirect.php?c=50&cs=57fee5a95bfa81d1e4eecbe40189b12d&thurl=>";
    ...
    private static String m_messageID_Domain = "projectacorn.com";
    ...
    private static String m_listUnsubscribe_Domain = "list-unsubscribe.projectacorn.com";
